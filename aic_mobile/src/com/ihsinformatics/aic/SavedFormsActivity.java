	...
	public void onClick (View view)
	{
		...
		else if (view == submitFormsButton)
		{
			...
			else
			{
				...
				if(!flag){
					App.getDialog (this, AlertType.ERROR, getResources().getString(R.string.no_selection),Gravity.CENTER_HORIZONTAL).show ();
				}	
				else {
					final Dialog d = App.getDialog(this, AlertType.QUESTION, getResources ().getString (R.string.delete_forms),Gravity.CENTER_HORIZONTAL);
					App.setDialogTitle(d, getResources ().getString (R.string.delete_form));
					...
					try
					{
						...
						if (jsonResponse.has ("response"))
						{
							...
							if (result.equalsIgnoreCase ("SUCCESS"))
							{
								...
								responses.add ("<font color=\"green\">" + formName + " (" + DateTimeUtil.getSQLDate (date) + "): " + result + "</font>");
								serverService.deleteSavedForm (formTimestamp);
							}
							else
							{
								responses.add ("<font color=\"red\">" + formTimestamp.toString () + " (" + formName + "). " + response + "</font>");
							}
						}
						else
						{
