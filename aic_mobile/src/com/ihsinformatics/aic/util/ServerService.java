...
public class ServerService {
	...
	public void fetchMetadata(){
		...
		try
		{
			...
			dbUtil.delete(Metadata.METADATA_TABLE, "type = '" +  Metadata.OPD + "'" , null);
			...
			for(int i = 0; i<opdSize; i++){
				...
				// If the user doesn't exist in DB, save it
				String id = dbUtil.getObject (Metadata.METADATA_TABLE, "id", "type='" + Metadata.OPD + "' AND name='" +  jsonResponse.getString ("opd_"+i) + "'");
				if (id == null)
				{
					dbUtil.insert (Metadata.METADATA_TABLE, values);
				}
			...
			dbUtil.delete(Metadata.METADATA_TABLE, "type = '" +  Metadata.OPD_AREA+ "'" , null);
			...
			for(int i = 0; i<opdAreaSize; i++){
				...
				// If the user doesn't exist in DB, save it
				String id = dbUtil.getObject (Metadata.METADATA_TABLE, "id", "type='" + Metadata.OPD_AREA + "' AND name='" +  jsonResponse.getString ("opd_area_"+i) + "'");
				if (id == null)
				{
					dbUtil.insert (Metadata.METADATA_TABLE, values);
				}
			...
			dbUtil.delete(Metadata.METADATA_TABLE, "type = '" +  Metadata.LOCATION+ "'" , null);
			...
			for(int i = 0; i<locationSize; i++){
				...
				// If the user doesn't exist in DB, save it
				String id = dbUtil.getObject (Metadata.METADATA_TABLE, "id", "type='" + Metadata.LOCATION + "' AND name='" +  jsonResponse.getString ("loc_"+i) + "'");
				if (id == null)
				{
					dbUtil.insert (Metadata.METADATA_TABLE, values);
				}
